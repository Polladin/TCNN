...
public:
    TCNN_opt_function();
    TCNN_opt_function(unsigned const &amount_chaotic_functions, double chaotic_step_length = 0.1);
    ...
    void init_optimizer_set_amount_chaotic_func (unsigned const& amount_chaotic_functions, double chaotic_step_length);
